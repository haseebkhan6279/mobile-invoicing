...
export default function LoginPage() {
  return (
    <div className="relative flex min-h-screen items-center justify-center overflow-hidden bg-gradient-to-b from-[#07162f] to-[#0a1f3d] p-4">
      ...
      <div className="relative w-full max-w-md rounded-2xl bg-white p-8 shadow-2xl ring-1 ring-black/5 dark:bg-slate-900 dark:ring-white/10">
        <div className="mb-6 flex items-center gap-3">
          ...
          <div>
            <div className="text-xs font-semibold tracking-[0.25em] text-sky-700 dark:text-sky-400">
              {company.shortName.toUpperCase()}
            </div>
            <h1 className="text-xl font-semibold text-slate-900 dark:text-slate-100">Wholesale Ops</h1>
          </div>
        </div>
